...
commandStanfordEvents.prototype.helpResponse = function (cb, output) {
  var output = {
    ...
    text: output +
      'You can get a list of featured events for today by entering either: /se featured or just /se' + '\n' +
      'You can get a list of featured events for a specific month by entering (ex. for July): /se month 7' + '\n' +
